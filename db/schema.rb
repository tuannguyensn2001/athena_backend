...
ActiveRecord::Schema[7.0].define(version: 2023_11_12_141753) do
  ...
  create_table "feature_flag_objects", force: :cascade do |t|
  ...
  create_table "schedule_attendances", force: :cascade do |t|
    t.integer "user_id"
